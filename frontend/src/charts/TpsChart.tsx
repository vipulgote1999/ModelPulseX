      ...
      <div className="h-[260px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={rows}>
            ...
            <XAxis dataKey="time" tick={{ fontSize: 11, fill: "#a1a1aa" }} interval="preserveStartEnd" />
            <YAxis tick={{ fontSize: 11, fill: "#a1a1aa" }} label={{ value: "TPS", angle: -90, position: "insideLeft", fill: "#a1a1aa" }} />
            <Tooltip contentStyle={{ background: "#18181b", border: "1px solid #3f3f46", borderRadius: 10 }} labelStyle={{ color: "#e4e4e7" }} />
            <Legend />
            {series.map((s, i) => (
