...
- **Issue tracking is GitHub** (github.com/vipulgote1999/ModelPulseX) per owner decision 2026-09-10 — file new tickets there, not in Linear. Linear project "ModelPulseX" keeps the historical record (MED-171..MED-185) because its free workspace hit the issue-creation cap; existing Linear issues can still be updated and Linear documents still work.
