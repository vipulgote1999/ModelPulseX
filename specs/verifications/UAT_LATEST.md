> **Superseded 2026-09-10:** see `UAT_2026-09-10.md` for the current build (19 providers, 14 migrations, 4 crons, 139 tests) and the gates actually run. This file describes the 2026-08-23 two-provider build and is kept for history.
